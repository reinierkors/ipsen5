...
public class TaxonRepository extends RepositoryMaria<Taxon>{
	...
	private PreparedStatement psFindByName() throws SQLException{
		return connection.prepareStatement(queryFindByName);
	}
	...
	protected ColumnData[] getColumns(){
		return new ColumnData[]{new ColumnData<>("id", Types.INTEGER, Taxon::getId, Taxon::setId, true), new ColumnData<>("name", Types.VARCHAR, Taxon::getName, Taxon::setName), new ColumnData<>("group_id", Types.INTEGER, Taxon::getGroupId, Taxon::setGroupId), new ColumnData<>("level_id", Types.INTEGER, Taxon::getLevelId, Taxon::setLevelId), new ColumnData<>("parent_id", Types.INTEGER, Taxon::getParentId, Taxon::setParentId), new ColumnData<>("refer_id", Types.INTEGER, Taxon::getReferId, Taxon::setReferId)};
	}
