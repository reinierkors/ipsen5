...
public class ReferenceRepository extends RepositoryMaria<Reference>{
	...
	protected ColumnData[] getColumns() {
		return new ColumnData[]{
				new ColumnData<>("id", Types.INTEGER, Reference::getId, Reference::setId, true),
				new ColumnData<>("watertype_id", Types.INTEGER, Reference::getWatertypeId, Reference::setWatertypeId),
		};
	}
